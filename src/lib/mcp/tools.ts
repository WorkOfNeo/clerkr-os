...
export const TOOLS: ToolDef[] = [
  {
    ...
    description:
      ...
      "Call this when the user wants to save something: a URL they pasted, an " +
      "image they attached (call `upload_image` first to host it, then pass " +
      "that URL as `imageUrl`), or a verbal idea. Fill every field you " +
      "reasonably can — title, description, imageUrl, category, todo (what " +
      "to build/do), painPoint (problem it solves), priority. " +
      "The author is automatically set to the owner of the API token making " +
      "this call.",
    inputSchema: {
      type: "object",
      properties: {
