...
export const TOOLS: ToolDef[] = [
  {
    ...
    description:
      ...
      "Call this when the user wants to save something — a URL, an attached " +
      "image, or a verbal idea. Fill every field you reasonably can: title, " +
      "description, imageUrl (only if you have a public image URL — the field " +
      "is a URL string, never image bytes), category, todo (what to build/do), " +
      "painPoint (problem it solves), priority. The author is automatically " +
      "set to the owner of the API token making this call.",
    inputSchema: {
      type: "object",
      properties: {
